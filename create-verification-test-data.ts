...
async function createVerificationTestData() {
  try {
    ...
    const testData = [
      {
        full_name: JSON.stringify({ id: "114634365996976140", name: "Nguyễn Văn An" }),
      ...
      {
        full_name: JSON.stringify({ id: "114634366001234567", name: "Trần Thị Bình" }),
      ...
      {
        full_name: JSON.stringify({ id: "114634366007890123", name: "Lê Minh Cường" }),
      ...
      {
        full_name: JSON.stringify({ id: "114634366012345678", name: "Phạm Thị Diệu" }),
      ...
      {
        full_name: JSON.stringify({ id: "114634366018901234", name: "Hoàng Văn Emso" }),

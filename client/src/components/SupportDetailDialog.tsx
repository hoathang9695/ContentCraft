        ...
        <div className="p-6 pb-0">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-[100px,1fr] items-center">
              ...
              <span className="text-blue-600 font-medium">{request.full_name}</span>
            </div>

            <div className="grid grid-cols-[100px,1fr] items-center">
              <span className="text-muted-foreground">Email:</span>
              <span className="text-blue-600 font-medium">{request.email}</span>
            </div>

            <div className="grid grid-cols-[100px,1fr] items-center">
              <span className="text-muted-foreground">Chủ đề:</span>
              <span className="text-blue-600 font-medium">{request.subject}</span>
            </div>

      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="bg-yellow-50 text-yellow-800 p-3 rounded-md text-sm">
            ...
            <p className="mt-1">
              {fakeUsers.length > 0 
                ? "Hệ thống sẽ tự động chọn ngẫu nhiên một người dùng ảo khác nhau để gửi mỗi follow request" 
                : selectedGender === 'all' 
            ...
            {fakeUsers.length > 0 && (
              <p className="mt-1 text-xs">
                {selectedGender === 'all' 
                  ? `Có tổng cộng ${fakeUsers.length} người dùng ảo có thể sử dụng để gửi follow request`
                  : `Có ${fakeUsers.length} người dùng ảo ${(() => {
                    ...
                    })()} có thể sử dụng để gửi follow request`}
              </p>
            )}
        ...
        <div className="flex justify-end gap-3">
          ...
          <Button 
            ...
            disabled={isProcessing || fakeUsers.length === 0 || !count || parseInt(count, 10) <= 0}
          >
